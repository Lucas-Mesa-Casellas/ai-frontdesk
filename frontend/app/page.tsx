...
const T: Record<LangCode, Dict> = {
  ...
  ES: {
    ...
    lede: "LMC Agents contesta cada llamada, entiende qué necesita la persona que llama, actúa en consecuencia, y te informa de lo que ha pasado. De día y de noche.",

...
const T: Record<LangCode, Dict> = {
  EN: {
    ...
    lede: "LMC Agents answers every call, understands what the caller needs, handles what comes next, and then tells you what happened. Day and night.",
  ...
  ES: {
    ...
    lede: "LMC Agents contesta cada llamada, entiende qué necesita la persona que llama, se encarga de lo que viene después y luego te cuenta qué ha pasado. De día y de noche.",
  ...
  FR: {
    ...
    lede: "LMC Agents répond à chaque appel, comprend ce dont l'appelant a réellement besoin, s'occupe de la suite et vous dit ensuite exactement ce qui s'est passé. De jour comme de nuit.",
    ...
    feats: [
      [{ t: "Répond 24/7, nuits et week-ends compris" },
       ...
       { t: "Demandes de réservation envoyées dans votre tableau de bord" },

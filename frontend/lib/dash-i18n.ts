...
export type DashDict = {
  ...
  calConfirmed_: string; calNoDate: string; calUndatedTitle: string; calSelectDay: string; calDayEmpty: string; calCancel: string; calCancelling: string; calCancelled: string; calStatsThisMonth: string; calActionError: string; calReason: string; calNoReason: string; people: (n: number) => string;

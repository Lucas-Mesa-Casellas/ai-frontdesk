...
export type DashDict = {
  ...
  calConfirmed_: string; calNoDate: string; calUndatedTitle: string; calSelectDay: string; calDayEmpty: string; calCancel: string; calCancelling: string; calCancelled: string; calStatsThisMonth: string; people: (n: number) => string;
...
export const DASH_T: Record<Locale, DashDict> = {
  en: {
    ...
    calNoDate: "No date given", calUndatedTitle: "Requests without a date", calSelectDay: "Select a day to see its bookings.", calDayEmpty: "No bookings this day.", calCancel: "Cancel", calCancelling: "Cancelling…", calCancelled: "Cancelled", calStatsThisMonth: "This month", people: (n) => `${n} ${n === 1 ? "person" : "people"}`,
  ...
  es: {
    ...
    calNoDate: "Sin fecha indicada", calUndatedTitle: "Solicitudes sin fecha", calSelectDay: "Selecciona un día para ver sus citas.", calDayEmpty: "Sin citas ese día.", calCancel: "Cancelar", calCancelling: "Cancelando…", calCancelled: "Cancelado", calStatsThisMonth: "Este mes", people: (n) => `${n} ${n === 1 ? "persona" : "personas"}`,
  ...
  fr: {
    ...
    calNoDate: "Aucune date indiquée", calUndatedTitle: "Demandes sans date", calSelectDay: "Sélectionnez un jour pour voir ses rendez-vous.", calDayEmpty: "Aucun rendez-vous ce jour.", calCancel: "Annuler", calCancelling: "Annulation…", calCancelled: "Annulé", calStatsThisMonth: "Ce mois-ci", people: (n) => `${n} ${n === 1 ? "personne" : "personnes"}`,
